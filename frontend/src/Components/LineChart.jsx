...
const LineGraph = ({ data, filters }) => {
  ...
  return (
    <div className="p-4">
      <h2 className="text-xl font-bold mb-4">Line Graph Visualization</h2>
      ...
      <p className="mt-4">
        This line graph visualizes the {yAxis} of various {xAxis} from the{" "}
